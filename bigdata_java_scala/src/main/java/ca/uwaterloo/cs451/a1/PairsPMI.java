...
public class PairsPMI extends Configured implements Tool {
  ...
  public static final class MapperPMI extends Mapper<LongWritable, Text, PairOfStrings, IntWritable> {
    private static final IntWritable ONE = new IntWritable(1);
  ...
  public static final class CombinerPMI extends Reducer<PairOfStrings, IntWritable, PairOfStrings, IntWritable> {
    private static final IntWritable SUM = new IntWritable();
  ...
  public static final class ReducerPMI extends Reducer<PairOfStrings, IntWritable, PairOfStrings, PairOfFloatInt> {
    ...
    public void reduce(PairOfStrings key, Iterable<IntWritable> values, Context context)
      ...
      if (sum >= threshold) {
        ...
        float denom = wordCount.get(right)*wordCount.get(left);
        float numer = sum * lineCount;
